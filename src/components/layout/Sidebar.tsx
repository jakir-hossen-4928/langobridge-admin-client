...
export default function Sidebar({
  ...
  return (
    <aside
      className={cn(
        "h-screen bg-card border-r transition-all duration-300 flex flex-col border-0 lg:border-r",
        isCollapsed ? "w-20" : "w-64",
        isMobileMode && "w-full border-0 h-full",
      )}
    >
      ...
      <div className="p-4 border-t mt-auto space-y-4">
        ...
        <div
          className={cn(
            ...
            isCollapsed && !isMobileMode && "justify-center",
          )}
        >
          {isConnected === true ? (
            <Database size={18} />
          ...
          {(!isCollapsed || isMobileMode) && (
            <div className="flex flex-col min-w-0">
              <span className="text-[10px] font-black uppercase tracking-widest text-inherit/50 leading-tight">
                Database
              </span>
